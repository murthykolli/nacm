...
@Entity
@Table(name = "guest_concept_boards_individual_payment_saving")
public class GuestConceptBoardsIndividualPaymentSaving implements java.io.Serializable {
	
	// Fields
	
	private long guestConceptBoardsIndividualPaymentSavingId;
	...
	/** default constructor */
	public GuestConceptBoardsIndividualPaymentSaving() {
	}
	...
	@Column(name = "guest_concept_boards_individual_payment_saving_id", unique = true, nullable = false)
	public long getGuestConceptBoardsIndividualPaymentSavingId() {
		return guestConceptBoardsIndividualPaymentSavingId;
	}

	public void setGuestConceptBoardsIndividualPaymentSavingId(long guestConceptBoardsIndividualPaymentSavingId) {
		this.guestConceptBoardsIndividualPaymentSavingId = guestConceptBoardsIndividualPaymentSavingId;
	}	
