...
@Entity
@Table(name = "shop_finishing_touches_products_info_saving")
public class ShopFinishingTouchesProductsInfoSaving implements java.io.Serializable {
	
	// Fields
	
	private long shopFinishingTouchesProductsInfoSavingId;
	private long adminRegistryFinishingTouchesSavingId;	
	...
	/** default constructor */
	public ShopFinishingTouchesProductsInfoSaving() {
	}
	...
	@Column(name = "shop_finishing_touches_products_info_saving_id", unique = true, nullable = false)
	public long getShopFinishingTouchesProductsInfoSavingId() {
		return shopFinishingTouchesProductsInfoSavingId;
	}

	public void setShopFinishingTouchesProductsInfoSavingId(long shopFinishingTouchesProductsInfoSavingId) {
		this.shopFinishingTouchesProductsInfoSavingId = shopFinishingTouchesProductsInfoSavingId;
	}

	@Column(name = "admin_registry_finishing_touches_saving_id", nullable = false)
	public long getAdminRegistryFinishingTouchesSavingId() {
		return adminRegistryFinishingTouchesSavingId;
	}

	public void setAdminRegistryFinishingTouchesSavingId(long adminRegistryFinishingTouchesSavingId) {
		this.adminRegistryFinishingTouchesSavingId = adminRegistryFinishingTouchesSavingId;
	}
