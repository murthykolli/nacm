...
@Entity
@Table(name = "admin_registry_finishing_touches_products_info_saving")
public class AdminRegistryFinishingTouchesProductsInfoSaving implements java.io.Serializable {
	
	// Fields
	
	private long adminRegistryFinishingTouchesProductsInfoSavingId;
	...
	private String finishingTouchesStatus;
	...
	/** default constructor */
	public AdminRegistryFinishingTouchesProductsInfoSaving() {
	}
	...
	@Column(name = "admin_registry_finishing_touches_saving_id", unique = true, nullable = false)
	public long getAdminRegistryFinishingTouchesProductsInfoSavingId() {
		return adminRegistryFinishingTouchesProductsInfoSavingId;
	}

	public void setAdminRegistryFinishingTouchesProductsInfoSavingId(long adminRegistryFinishingTouchesProductsInfoSavingId) {
		this.adminRegistryFinishingTouchesProductsInfoSavingId = adminRegistryFinishingTouchesProductsInfoSavingId;
	}
	...
	@Column(name = "finishing_touches_status", length = 30)
	public String getFinishingTouchesStatus() {
		return finishingTouchesStatus;
	}

	public void setFinishingTouchesStatus(String finishingTouchesStatus) {
		this.finishingTouchesStatus = finishingTouchesStatus;
	}
