...
@Entity
@Table(name = "registrant_finishing_touches_contributed_products_info_saving")
public class RegistrantFinishingTouchesContributedProductsInfoSaving implements java.io.Serializable {
	...
	/** default constructor */
	public RegistrantFinishingTouchesContributedProductsInfoSaving() {
	}
	...
	@Column(name = "registrant_finishing_touches_contributed_products_info_saving_id", unique = true, nullable = false)
