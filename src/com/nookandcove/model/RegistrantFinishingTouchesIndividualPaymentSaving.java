...
@Entity
@Table(name = "registrant_finishing_touches_individual_payment_saving")
public class RegistrantFinishingTouchesIndividualPaymentSaving implements java.io.Serializable {
	
	// Fields
	
	private long registrantFinishingTouchesIndividualPaymentSavingId;
	...
	/** default constructor */
	public RegistrantFinishingTouchesIndividualPaymentSaving() {
	}
	...
	@Column(name = "registrant_finishing_touches_individual_payment_saving_id", unique = true, nullable = false)
	public long getRegistrantFinishingTouchesIndividualPaymentSavingId() {
		return registrantFinishingTouchesIndividualPaymentSavingId;
	}

	public void setRegistrantFinishingTouchesIndividualPaymentSavingId(long registrantFinishingTouchesIndividualPaymentSavingId) {
		this.registrantFinishingTouchesIndividualPaymentSavingId = registrantFinishingTouchesIndividualPaymentSavingId;
	}	
