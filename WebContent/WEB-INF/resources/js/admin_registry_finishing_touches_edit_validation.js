	...
	var loadFile1 = function(event) {
		...
		if(fileUploadName1 !== "") {			
			...
			$("#productUploadImage1ID").val(fileUploadName1);
		}
  	};
	...
	var loadFile2 = function(event) {
		...
		if(fileUploadName2 !== "") {
			...
			$("#productUploadImage2ID").val(fileUploadName2);
		} 		
  	};
	...
	var loadFile3 = function(event) {
		...
		if(fileUploadName3 !== "") {
			var output = document.getElementById('output3');
		  	...
		  	$("#productUploadImage3ID").val(fileUploadName3);
		}		
  	};
	...
	var loadFile4 = function(event) {
		...
		if(fileUploadName4 !== "") {
			var output = document.getElementById('output4');
		  	...
		  	$("#productUploadImage4ID").val(fileUploadName4);
		}
  	};
  	...
  	$(document).ready(function(){
		...
		$("#productUploadImage1ID").val(null);
		return false;
 		});
		...
		$("#productUploadedImage2").val(null);
 		$("#productUploadImage2ID").val(null);
 		return false; 		
 		});
		...
		$("#productUploadedImage3").val(null);
 		$("#productUploadImage3ID").val(null);
 		return false; 		
 		});
 		...
 		$("#productUploadImage4ID").val(null);
 		return false;
 		});
...
/*Furniture Spec Edit Button Validation*/
 	    
 	   $("#admFTFurnitureSpecsEditButtId").click(function (){
 	 	    var result = true;
 	 	    if(nameRegExp.test($("#productCategoryId").val())){ $("#productCategoryId").css("border-color","black");
 	 	    } else{ $("#productCategoryId").css("border-color","red"); result=false; }
 	 	    ...
 	 	    var fileUpName1 = $("#productUploadImage1ID").val(); 	 	    
 	 	    if(fileUpName1 !== "") { 	 	    	
