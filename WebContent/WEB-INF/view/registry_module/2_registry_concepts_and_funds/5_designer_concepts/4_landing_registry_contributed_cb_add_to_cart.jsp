...
<html>
	...
	<script type="text/javascript">
 	$(document).ready(function() {
 	 	...
 	 	var regCBContributeAmount = "<c:out value="${regCBCotributedPrice}"/>";
 	 	if(regCBContributeAmount !== "null") { 
 	 		$("#regiFundAmountId").val(regCBContributeAmount);
 	 	} else {
		        ...
		        <div align="left">		        
				    <div class="row">						
						<div class="col-md-12 col-sm-12">
							...
							<div><img src="${regCBCotributedProductImage}" class="reg_cb_contributed_image_dsp"></div>
							</div>							
						</div>
						
				        <div class="col-md-12 col-sm-12">
				        <div align="center" style="margin-top: 20px;" id="cbontributedNewNameTextId" class="reg_cb_contributed_name_dsp">${regCBCotributedProductName}</div>			
				        </div>
			        ...
			        <div class="row top_adjustment_60">
						<div class="col-md-12 col-sm-12">
							<div align="center" class="regi_guest_fund_rstest_dsp"><p>CONTRIBUTE ANY AMOUNT TOWARDS THE ${regCBCotributedProductName}:</p></div>
						</div>
					    ...
					    <td><input type="text" name="regCBCotributedPrice" id="regiFundAmountId" maxLength="8" class="reg_guest_rsinput_amount_fld_cl" onkeypress="return numeralsOnly(event,this.id);"></td>
					    </tr>
					    </table>
					    <div class="reg_guest_st_need_amt_text" id="regStillNeedAmountId" style="display: none;">STILL NEEDS: $${regCBCotributedRemainingPrice}</div>
					    </div>
