...
<html>
	...
	<style type="text/css">	
	.reg_sc_popup_prod_name_hd { font: normal 1.0em/1.5em Georgia; text-align: left; letter-spacing: 1px; color: black; margin-top: -5px; padding-bottom: 15px; text-transform: uppercase; }
...
<!-- Pop up CSS Code Start -->
	...
	$('#selectedSizeId').on('change', function() {		
		...
		$("#regSelectedPriceID").html(selPriceValue);
		$("#regProductSizeId").val(selSizeValue);
		$("#registryPriceId").val(selPriceValue);		
	});
	
	var conSeptValuesQut1 = "<c:out value="${productSize}"/>"; var conSeptValuesLet1 = "<c:out value="${productSize}"/>";
	conSeptValuesQut1 = conSeptValuesQut1.replace(/&amp;#034;/g,"\""); conSeptValuesQut1 = conSeptValuesQut1.replace(/&amp;#039;/g,"'"); conSeptValuesLet1 = conSeptValuesLet1.replace(/&amp;#034;/g,"D"); conSeptValuesLet1 = conSeptValuesLet1.replace(/&amp;#039;/g,"S");		
	var htmlValue = '<option value="'+conSeptValuesLet1+'">'+conSeptValuesQut1+'</option>';
	$("#bdValueOptionHideId").append(htmlValue); 
		...
		<div id="mainframe" class="section-content">
        	<div class="container">
        		...
        		<div class="row">        
					<div class="col-md-12 col-sm-12" style="margin-top: -30px; margin-left: -15px;">
        				<div align="right"> <a href="registryOverview"><img src="resources/images/registry/close_img.png" onmouseover="this.src='resources/images/registry/close_mo_img.png'" onmouseout="this.src='resources/images/registry/close_img.png'" border="0" title="CLOSE"></a></div>
        			</div>
        		</div>
        		
        		<div class="row" style="padding: 20px;">        
					<div class="col-md-5 col-sm-5">
				    	<div class="reg_popup_pro_sub_left_frame_dsp">
				     	<img id="bigImgDsplayCl" class="reg_popup_pro_big_image_disl">
				        </div>
				        
				        <table> <tbody> 
					      	<tr> <td> <img class="smlImgClickCl" id="popupImage1Id"> </td>					       	
					       	<td style="position: relative; left: 50px;"> <img class="smlImgClickCl" id="popupImage2Id"> </td> </tr>
					        	
					       	<tr> <td> <img class="smlImgClickCl" id="popupImage3Id"> </td>					        	
					       	<td style="position: relative; left: 50px;"> <img class="smlImgClickCl" id="popupImage4Id"> </td> </tr>
			        	</tbody> </table>
			        </div>
			        
			        <div class="col-md-7 col-sm-7">
			        	<div style="padding-left: 10px; margin-top: 30px;">
			        	<form action="regCBContributedSelectedProductDataUpdate" method="POST">
			        	...
			        	<div class="reg_popup_prod_sub_frame_dsp">
			        		...
			        		<div align="left">
			        		<select id="productQuantityId" name="productQuantity" class="reg_popup_prod_sel_box_qunty"> 
			        		...
			        		<div id="enableGGTextDspYesId">
				        		...
				        		<div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer;" class="fa">&#xf059;</i>
	         					<span class="mytext" style="margin-top: -65px;"> Receive cash contributions towards this item and collect funds once the total has been met.<br><br>The Group Gifting feature cannot be disabled once contributions towards a gift have begun. </span>
	      						</div>
	      						</div>
      						</div>
      						...
      						<div id="enableGGTextDspNoId" style="display: none;">
      							<div class="reg_sc_enb_gg_text_dsp">ENABLE GROUP GIFTING&nbsp;&nbsp;
				        		<div class="mytooltip" style="margin-left: 0px;"><i style="font-size: 18px; cursor: pointer;" class="fa">&#xf059;</i>
	         					<span class="mytext" style="margin-top: -15px;"> Either one or multiple guests have already contributed towards this item, therefore you can no longer disable the Group Gifting feature. </span>
	         					</div>
	      						</div>
      						</div>
							...
							<table>
							<tr><td><input type="checkbox" id="hidePriceFromGuestId" name="hidePriceFromGuest" value="Hide Price From Guest"></td> <td> <font class="reg_popup_hide_text_hd">&nbsp;HIDE PRICE FROM GUESTS</font></td></tr>
							</table>							
							</div> -->
			        		...
			        		<tr><td align="left">
			        			<select id="selectedSizeId" class="reg_popup_prod_sel_box_size" name="registrySize" style="margin-top: -8px;">
			        				<option id="bdValueOptionHideId"></option>						        
							    </select>				        		
			        		</td></tr>
			        		</table>							
							</div>
							...
							<button class="regi_add_to_registry_sbut">ADD TO REGISTRY</button>
							</div>
			        	...
			        	<div style="margin-top: 15px;">
			        		<div class="reg_sc_popup_prod_quantity_hd">DESCRIPTION</div>
			        		<!-- <div class="reg_sc_popup_prod_quantity_hd" style="display: none;" id="productDescShowHide1ID"><font id="regProductDesc1ID"></font></div>
			        		<div class="reg_sc_popup_prod_quantity_hd" style="display: none;" id="productDescShowHide2ID"><font id="regProductDesc2ID"></font></div>
			        		<div class="reg_sc_popup_prod_quantity_hd" style="display: none;" id="productDescShowHide3ID"><font id="regProductDesc3ID"></font></div>
			        		<div class="reg_sc_popup_prod_quantity_hd" style="display: none;" id="productDescShowHide4ID"><font id="regProductDesc4ID"></font></div>
			        		<div class="reg_sc_popup_prod_quantity_hd" style="display: none;" id="productDescShowHide5ID"><font id="regProductDesc5ID"></font></div> -->
			        		<div class="reg_sc_popup_prod_quantity_hd">${productsDescription}</div>
			        	</div>
		...
		var totalProdPopUpValues = "<c:out value="${totalProdPopUpValuesList}"/>";
		var conSeptValues = totalProdPopUpValues.split("_,_"); 
	
		$("#regProductNameID").html(conSeptValues[0]);	
		var image1Val = "data:image/jpg;base64,"+conSeptValues[1]+"";
		var image2Val = "data:image/jpg;base64,"+conSeptValues[2]+"";
		var image3Val = "data:image/jpg;base64,"+conSeptValues[3]+"";
		var image4Val = "data:image/jpg;base64,"+conSeptValues[4]+"";
	...
	/*Heading Radio Buttons Display Code*/
		...
		if(conSeptValues[6] !== "") {
			var conSeptValuesCon1 = conSeptValues[6]; var conSeptValuesLt1 = conSeptValues[6];
	    	...
	    	htmlVal = '<option value="'+sizePriceComb1+'">'+conSeptValuesCon1+'</option>';
	    	$("#selectedSizeId").append(htmlVal);    	
		}
			
		if(conSeptValues[8] !== "") {
			var conSeptValuesCon2 = conSeptValues[8]; var conSeptValuesLt2 = conSeptValues[8];
			...
			htmlVal = '<option value="'+sizePriceComb2+'">'+conSeptValuesCon2+'</option>';
			$("#selectedSizeId").append(htmlVal);
		}
		
		if(conSeptValues[10] !== "") {
			var conSeptValuesCon3 = conSeptValues[10]; var conSeptValuesLt3 = conSeptValues[10];
			...
			htmlVal = '<option value="'+sizePriceComb3+'">'+conSeptValuesCon3+'</option>';
	    	$("#selectedSizeId").append(htmlVal);
		}
		
		if(conSeptValues[12] !== "") {
			var conSeptValuesCon4 = conSeptValues[12]; var conSeptValuesLt4 = conSeptValues[12];
			...
			htmlVal = '<option value="'+sizePriceComb4+'">'+conSeptValuesCon4+'</option>';
	    	$("#selectedSizeId").append(htmlVal);
		}
		
		if(conSeptValues[14] !== "") {
			var conSeptValuesCon5 = conSeptValues[14]; var conSeptValuesLt5 = conSeptValues[14];
			...
			htmlVal = '<option value="'+sizePriceComb5+'">'+conSeptValuesCon5+'</option>';
	    	$("#selectedSizeId").append(htmlVal);
		}
		...
		var productSize1 = "<c:out value="${productSize}"/>";
		var priceValue = "<c:out value="${productsPrice}"/>";
		var productCount = "<c:out value="${productsCount}"/>";
		var enableGroupGifts = "<c:out value="${enableGroupGift}"/>";
		var hidePriceGuests = "<c:out value="${hidePriceGuest}"/>";		
		...
		if(enableGroupGifts === "Enable Group Gift") {
			$("#enableGroupOffId").show();
			$("#enableGroupOff1Id").show();
	    	$("#enableGroupOnId").hide();
	    	$("#enableGroupOn1Id").hide();
		...
		if(hidePriceGuests === "Hide Price From Guest") {
			$("#hidePriceFromGuestId").prop("checked", true);
		}
		
		$("#regProductSizeId").val(productSize1);
		$("#registryPriceId").val(priceValue);
					
		$("#regProductOPPriceID").html(priceValue.replace(/\B(?=(\d{3})+(?!\d))/g, ","));
		$("#selectedSizeId").val(productSize1);
				
		$("[name=productQuantity]").val(productCount);
