	        ...
	        <div class="row top_adjustment_50">
				<div class="col-md-12 col-sm-12" align="center">	
					<table> <tbody> <tr>
						...
						<form action="regCashFundBack" method="get">
				        ...
				        <td>			        
					        <form action="regTopCashFundsInfoUpdating" name="regiAddGift" method="get">
		        ...
		        <div align="left">		        
				    <div class="row top_adjustment_30">
				        ...
				        <div class="col-md-12 col-sm-12" style="margin-top: 30px;">
				        	<div align="center" style="margin-top: 38px;" id="cashFundNameSmlId" class="cash_fund_side_hdtext_dsp">${cashFundName}</div>			
				        </div>		        
