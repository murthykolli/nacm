...
<html>
    ...
    .cash_fund_image_dsp { height: 180px; object-fit: scale-down; position: relative; object-position: 50% 50%; overflow: auto; overflow-y: hidden; overflow-x: hidden; width: 100%; }
    ...
    .cash_fund_hdtext_dsp { font: bold 1.4em/1.5em Georgia; color: black; letter-spacing: 3px; text-align: center; vertical-align: middle; }
	...
	<script type="text/javascript">
 	$(document).ready(function(){ 
 		...
 		return result;
 	 	...
 	 	var len = cashFundsMessage1.length;    	
        if (len >= 103) {
	        ...
	        <div class="row top_adjustment_50">
				<div class="col-md-12 col-sm-12" align="center">	
					<table> <tbody> <tr>
						...
						<form action="regCustomFundBack" method="get">
				        ...
				        <td>			        
			            	...
			            	<input type="hidden" id="cashFundReqAmountId" name="cashFundReqAmount">
					 		...
					 		<input type="hidden" id="customFundOldNameId" name="customFundOldName" value="${customFundName}">
					 		<input type="hidden" id="cashFundsImgPathDspId" name="cashFundsImgPathDsp" value="${cashFundsImgPathDsp}">
					 		<input type="hidden" id="cashFundImagePathId" name="cashFundImagePath" value="${cashFundImagePath}">
...
<!-- Box display coding -->	        
		        ...
		        <div align="left">		        
				    <div class="row top_adjustment_30">
						<div class="col-md-12 col-sm-12">
							...
							<div><img src="<c:out value='${cashFundsImgPathDsp}'/>"class="cash_fund_guest_image_dsp"></div>
							</div>
						</div>
		...
		<div style="font:bold 1.2em/1.5em Georgia; margin-left:30px; color: black;">Upload Cash Fund Image</div>
