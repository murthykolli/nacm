	...
	<script type="text/javascript">
 	$(document).ready(function(){
 		...
 		$("#contGuestRegButtonId").click(function () {
	 		...
	 		var guetCustomFundNeedAmount1 = "<c:out value="${regCashFundsNeedAmount}"/>";
	 		var guestCustomFundNeedAmount1 = guetCustomFundNeedAmount1.replace(",","");
	 		var guestCustomFundNeedAmountDb = parseFloat(guestCustomFundNeedAmount1);
	 		var customFundCotributedPriceDb = parseFloat($("#contributeAmountId").val());	 		
	 		if(customFundCotributedPriceDb > guestCustomFundNeedAmountDb) {
		    ...
		    <div class="row">
		        ...
		        <div align="left">		        
			        ...
			        <div class="row top_adjustment_60">
						<div class="col-md-12 col-sm-12">
							<div align="center" class="regi_guests_fund_rstest_dsp"><p>CONTRIBUTE ANY AMOUNT TOWARDS THIS FUND:</p></div>
						</div>
						
						<form action="guestCustomFundInfoAddToCart" method="POST">
