...
<head>
	...
	.dropdown_sub_menu { position: absolute; top: 90%; left: -10%; z-index: 1000; display: none; float: left; min-width: 185px; padding: 5px 0px; margin: 2px 0px 0; list-style: none; background-color: white; }	
	</style>
