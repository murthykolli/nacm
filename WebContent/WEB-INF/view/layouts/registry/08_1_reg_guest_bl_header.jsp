...
<head>
    ...
    var totalCartItem = "<c:out value="${totalCartItems}"/>";
                ...
                <div class="container">
	                <div class="row">
	                        ...
	                        <div class="col-md-3 col-sm-3 col-xs-3">
		                        <div align="right" style="margin-left: 30px; margin-top: 10px;"><a href="regGuestMyShoppingCart"><img src="resources/images/payment_mob_cart_img.png" alt="shoppingcart"> <font id="roundShapsOutDspId"><span id="regCartValueDisp" style="display: none;"><font id="guestCartDspId">${cartCountInSn}</font></span></font></a></div>
	                        </div>	                        	                        
	                    </div>
                    ...
                    <div class="responsive-menu text-right visible-xs visible-sm">
                        ...
                        <div class="menu">
                            <ul>
                            	<!-- <li><a href="aboutUsForGuest">ABOUT N+C</a></li> -->
                            	<li class="current"><a href="guestRegistryMyAccount">&nbsp;&nbsp;GIVE A GIFT&nbsp;&nbsp;</a></li>
                            	<li><a href="regGuestMyShoppingCart"><img src="resources/images/payment_cart_img.jpg" alt="shoppingcart"> <font id="roundShapId"><span id="mobCartValueDisp" style="display: none;"><font id="guestCartMobDspId">${cartCountInSn}</font></span></font></a>
								</li>
                          	</ul>
                        </div> <!-- /.menu -->
                    </div> <!-- /.responsive-menu -->
