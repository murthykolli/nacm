        ...
        <div class="container">            
            <div class="row">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-description">
                        	<div class="footer-box-adj">   
								...
								<li>
									<a href="findRegistry">FIND A REGISTRY</a>
								</li>
								...
								<li>
									<a href="referralUserLogin">REFERRAL PROGRAM</a>
								</li>
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-description">
		                    ...
		                    <div class="footer-links">        
								...
								<li>
									<a href="registryTerms">TERMS</a>
								</li>
				
								<li>
									<a href="registryPrivacyPolicy">PRIVACY POLICY</a>
								</li>
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    ...
                    <table>
                    	<tr><td>
                    		<form action="createRegistry">
								<h4><button class="footerSubmitBtn" style="width: 260px; height: 40px;">CREATE A REGISTRY</button></h4>
							</form>
						</td></tr>
						
						<tr><td>
                    		<form action="findRegistry">
								<h4><button class="footerSubmitBtn" style="width: 260px; height: 40px;">FIND A REGISTRY</button></h4>
							</form>
						</td></tr>
