            ...
            <div class="main-header">
                <div class="container">
                    ...
                    <div class="responsive-menu text-right visible-xs visible-sm">
                        ...
                        <div class="menu">
                            <ul>
                            	<!-- <li><a href="design"><font class="reg_header_text_bcdsp">DESIGN SERVICES</font></a></li> -->
                            	<li><a href="registryShop">SHOP</a></li>
                            	<li><a href="https://blog.nookandcove.com">BLOG</a></li>
                            	<li class="current"><a href="findRegistry">FIND REGISTRY</a></li>
